...
\end{fact}
\begin{fact}
Given a degree-$k$ polynomial over a finite field $\F_p$, we can solve for its roots in time polynomial in $k$. \footnote{Refer to https://crypto.stanford.edu/pbc/notes/ep/root.html for the factorization algorithm details}
\end{fact}
